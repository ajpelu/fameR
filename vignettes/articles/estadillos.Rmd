...
knitr::include_graphics('../../docs/reference/figures/dicc_taxon.png')
```
...
knitr::include_graphics('../../docs/reference/figures/dicc_crs.png')
```
...
knitr::include_graphics('../../docs/reference/figures/entrada_datos.png')
```
...
knitr::include_graphics('../../docs/reference/figures/entrada_datos_suelo.png')
```
...
knitr::include_graphics('../../docs/reference/figures/entrada_datos_temperatura.png')
```
...
knitr::include_graphics('../../docs/reference/figures/entrada_datos_excrementos.png')
```
...
knitr::include_graphics('../../docs/reference/figures/entrada_datos_focal.png')
```
...
knitr::include_graphics('../../docs/reference/figures/entrada_datos_herbivoria.png')
```
...
knitr::include_graphics('../../docs/reference/figures/entrada_datos_vecindad.png')
```
...
knitr::include_graphics('../../docs/reference/figures/entrada_datos_cobertura.png')
```
...
knitr::include_graphics('../../docs/reference/figures/entrada_datos_contactos.png')
```
